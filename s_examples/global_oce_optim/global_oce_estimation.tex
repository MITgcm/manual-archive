% $Header: /u/gcmpack/manual/s_examples/global_oce_optim/global_oce_estimation.tex,v 1.12 2008/02/11 21:39:06 dfer Exp $
% $Name:  $
...
( experiment {\it  tutorial_global_oce_latlon}). Below, we describe some of
