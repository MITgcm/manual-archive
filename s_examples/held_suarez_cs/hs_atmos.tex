% $Header: /u/gcmpack/manual/s_examples/held_suarez_cs/Attic/hs_atmos.tex,v 1.4 2004/10/12 17:14:02 cnh Exp $
% $Name:  $

\section{Held-Suarez forcing atmospheric simulation on a latitude-longitude grid 2.8$^\circ$ resolution and on
...
the planetary atmospheric circulation in two different ways. 
...
sphere.
Five pressurce corrdinate levels are used in the vertical, ranging in thickness
from $100\,{\rm mb}$ at the bottom of the atmosphere to $300\,{\rm mb}$ in the middle atmosphere.
At this resolution, the configuration
can be integrated forward for many years on a single 
